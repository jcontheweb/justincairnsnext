...
export default function ServiceCard({ title, description, image }) {
  return (
    <Link href="/">
      <a className="relative flex flex-col items-start justify-between p-8 transition-all duration-200 bg-white border-t border-r border-gray-200 shadow-none group hover:shadow-xl hover:z-10">
        ...
        <div className="absolute bottom-0 right-0 p-3 transition-all duration-200 opacity-0 group-hover:opacity-50">
